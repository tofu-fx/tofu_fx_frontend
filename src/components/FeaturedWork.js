    ...
    return(
      <div className="featured-work">
        ...
        <div className="main-carousel" data-flickity='{ "wrapAround": true, "imagesLoaded": true, "groupCells": 1, "autoPlay": 7000 }'>
          <img src={image_urls[0]} alt="featured-1"/>
          <img src={image_urls[1]} alt="featured-2"/>
          <img src={image_urls[2]} alt="featured-3"/>
          <img src={image_urls[3]} alt="featured-4"/>
          <img src={image_urls[4]} alt="featured-5"/>
          <img src={image_urls[5]} alt="featured-6"/>
          <img src={image_urls[6]} alt="featured-7"/>
          <img src={image_urls[7]} alt="featured-8"/>
          <img src={image_urls[8]} alt="featured-9"/>
          <img src={image_urls[9]} alt="featured-10"/>
        </div>
